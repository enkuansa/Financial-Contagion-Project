...
* Final Code: Extension (Forbes–Rigobon) PART 3 (Covid-era BUBLE)
...
local stable_start  = td(01jan2019)
local stable_end    = td(18feb2020)
local turmoil_start = td(19feb2020) // S&P500 peak
local turmoil_end   = td(01jun2020) // S&P500 trough point (March 11, 2020) but extended to June to capture lingering effects
