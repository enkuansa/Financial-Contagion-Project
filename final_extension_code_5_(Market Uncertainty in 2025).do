...
* Final Code: Extension (Forbes–Rigobon) PART 5 (Market Uncertainty of 2025 )
...
local stable_start  = td(01jan2024)
local stable_end    = td(31dec2024)
local turmoil_start = td(01jan2025) // S&P500 peak
local turmoil_end   = td(30jun2025) // S&P500 trough point (May of 2022) but extended to June to capture lingering effects
...
local p = 5 // lag for returns
local q = 5 // lag for rates
