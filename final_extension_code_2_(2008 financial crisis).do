...
* Final Code: Extension (Forbes–Rigobon) PART 2 (2008 Crisis)
...
local alpha = 0.05 // alpha value or significance level
...
local stable_start  = td(01jan2007)
local stable_end    = td(14sep2008)
local turmoil_start = td(15sep2008) // Leheman Brother's collapse date, widely believed as the start of the global collapse
local turmoil_end   = td(01jun2009) // S&P500 trough point (March 9 2009) but extended to June to capture lingering effects
